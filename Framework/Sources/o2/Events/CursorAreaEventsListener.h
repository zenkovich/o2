...
namespace o2
{
    ...
    class CursorAreaEventsListenerInterface;

    // -----------------------------------------------------------------------------------
    // Cursors events listener delegate. Delegates all cursor events to listener interface
    // -----------------------------------------------------------------------------------
    class CursorAreaEventsListenerDelegate: public CursorAreaEventsListener
    {
    public:
        // Default constructor
        CursorAreaEventsListenerDelegate(RefCounter* refCounter, CursorAreaEventsListenerInterface& cursorListenerInterface);
    ...
    protected:
        CursorAreaEventsListenerInterface& mCursorListenerInterface;
    };
    ...
    protected:
        WeakRef<CursorAreaEventsListenerDelegate> mCursorEventsDelegate;

        friend class CursorAreaEventsListenerDelegate;
    };
}
