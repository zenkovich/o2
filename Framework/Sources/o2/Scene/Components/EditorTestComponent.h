...
{
	FIELD().INVOKE_ON_CHANGE_ATTRIBUTE(Test).SERIALIZABLE_ATTRIBUTE().NAME(mVecs).PUBLIC();
	FIELD().NAME(spritePropPtr).PUBLIC();
	FIELD().NAME(spriteProp).PUBLIC();
	FIELD().NAME(arr).PUBLIC();
	FIELD().INVOKE_ON_CHANGE_ATTRIBUTE(Test).SERIALIZABLE_ATTRIBUTE().NAME(mInteger).PUBLIC();
	...
	FIELD().INVOKE_ON_CHANGE_ATTRIBUTE(Test).SERIALIZABLE_ATTRIBUTE().NAME(mTestInsideVector).PUBLIC();
	FIELD().INVOKE_ON_CHANGE_ATTRIBUTE(Test).SERIALIZABLE_ATTRIBUTE().NAME(mTestInsideptrsVector).PUBLIC();
