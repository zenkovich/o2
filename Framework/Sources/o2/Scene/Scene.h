...
{
	FIELD().NAME(onAddedToScene).PUBLIC();
	FIELD().NAME(onRemovedFromScene).PUBLIC();
	FIELD().NAME(onEnableChanged).PUBLIC();
	FIELD().NAME(onLockChanged).PUBLIC();
	FIELD().NAME(onNameChanged).PUBLIC();
	FIELD().NAME(onChildrenHierarchyChanged).PUBLIC();
	FIELD().NAME(onObjectsChanged).PUBLIC();
	FIELD().NAME(onLayersListChanged).PUBLIC();
	FIELD().NAME(mCameras).PROTECTED();
	FIELD().NAME(mRootActors).PROTECTED();
	FIELD().NAME(mAllActors).PROTECTED();
	FIELD().NAME(mActorsMap).PROTECTED();
	FIELD().NAME(mAddedActors).PROTECTED();
	FIELD().NAME(mStartActors).PROTECTED();
	FIELD().NAME(mStartComponents).PROTECTED();
	FIELD().NAME(mDestroyActors).PROTECTED();
	FIELD().NAME(mDestroyComponents).PROTECTED();
	FIELD().NAME(mLayersMap).PROTECTED();
	FIELD().NAME(mLayers).PROTECTED();
	FIELD().NAME(mDefaultLayer).PROTECTED();
	FIELD().NAME(mTags).PROTECTED();
	FIELD().NAME(mCache).PROTECTED();
