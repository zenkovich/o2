...
CLASS_FIELDS_META(o2::EditBox)
{
	...
	FIELD().NAME(caret).PUBLIC();
	FIELD().NAME(selectionBegin).PUBLIC();
	FIELD().NAME(selectionEnd).PUBLIC();
	FIELD().NAME(onChanged).PUBLIC();
	FIELD().NAME(onChangeCompleted).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Color4(0.1f, 0.2f, 0.6f, 0.3f)).NAME(mSelectionColor).PROTECTED();
	FIELD().NAME(mLastText).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().NAME(mText).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().NAME(mAvailableSymbols).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(nullptr).NAME(mTextDrawable).PROTECTED();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mSelectionMesh).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(nullptr).NAME(mCaretDrawable).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(1.0f).NAME(mCaretBlinkDelay).PROTECTED();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mCaretBlinkTime).PROTECTED();
	FIELD().DEFAULT_VALUE(0).NAME(mSelectionBegin).PROTECTED();
	FIELD().DEFAULT_VALUE(0).NAME(mSelectionEnd).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mSelectingByWords).PROTECTED();
	FIELD().DEFAULT_VALUE(0).NAME(mSelWordBegin).PROTECTED();
	FIELD().DEFAULT_VALUE(0).NAME(mSelWordEnd).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(true).NAME(mMultiLine).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(false).NAME(mWordWrap).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(INT_MAX).NAME(mMaxLineChars).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(INT_MAX).NAME(mMaxLinesCount).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mJustFocused).PROTECTED();
	FIELD().DEFAULT_VALUE(-1.0f).NAME(mLastClickTime).PROTECTED();
	FIELD().NAME(mLastCursorPos).PROTECTED();
}
END_META;
