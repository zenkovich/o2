...
{
	FIELD().NAME(scroll).PUBLIC();
	FIELD().NAME(horScroll).PUBLIC();
	FIELD().NAME(verScroll).PUBLIC();
	FIELD().NAME(onScrolled).PUBLIC();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mHorScrollBar).PROTECTED();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mVerScrollBar).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mOwnHorScrollBar).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mOwnVerScrollBar).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mLayoutUpdated).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Layout::BothStretch()).NAME(mViewAreaLayout).PROTECTED();
	FIELD().NAME(mAbsoluteViewArea).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Layout::BothStretch()).NAME(mClipAreaLayout).PROTECTED();
	FIELD().NAME(mAbsoluteClipArea).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().NAME(mScrollPos).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mHasScrolled).PROTECTED();
	FIELD().NAME(mScrollSpeed).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(7.0f).NAME(mScrollSpeedDamp).PROTECTED();
	FIELD().NAME(mScrollArea).PROTECTED();
	FIELD().NAME(mScrollRange).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mEnableHorScroll).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mEnableVerScroll).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mUnderCursor).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mPressedCursor).PROTECTED();
	FIELD().NAME(mPressedScroll).PROTECTED();
	FIELD().NAME(mPressedCursorPos).PROTECTED();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mSpeedUpdTime).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(true).NAME(mEnableScrollsHiding).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(false).NAME(mShowScrollBarsByCursor).PROTECTED();
	FIELD().DEFAULT_VALUE(-1.0f).NAME(mLastHorScrollChangeTime).PROTECTED();
	FIELD().DEFAULT_VALUE(-1.0f).NAME(mLastVerScrollChangeTime).PROTECTED();
}
END_META;
