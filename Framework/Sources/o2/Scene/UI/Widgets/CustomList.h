...
CLASS_FIELDS_META(o2::CustomList)
{
	...
	PROTECTED_FIELD(mVerLayout).DEFAULT_VALUE(nullptr);
	PROTECTED_FIELD(mItemSample).DEFAULT_VALUE(nullptr).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mMultiSelection).DEFAULT_VALUE(true).SERIALIZABLE_ATTRIBUTE();
	...
	PROTECTED_FIELD(mSelectionLayout).DEFAULT_VALUE(Layout::BothStretch()).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mHoverLayout).DEFAULT_VALUE(Layout::BothStretch()).SERIALIZABLE_ATTRIBUTE();
