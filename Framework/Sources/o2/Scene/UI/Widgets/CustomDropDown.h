...
CLASS_FIELDS_META(o2::CustomDropDown)
{
	...
	PROTECTED_FIELD(mClipLayout).DEFAULT_VALUE(Layout::BothStretch()).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mAbsoluteClip);
	PROTECTED_FIELD(mMaxListItems).DEFAULT_VALUE(10).SERIALIZABLE_ATTRIBUTE();
}
END_META;
