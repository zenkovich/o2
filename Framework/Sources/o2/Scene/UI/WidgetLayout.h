...
CLASS_FIELDS_META(o2::WidgetLayout)
{
	...
	FIELD().NAME(minSize).PUBLIC();
	FIELD().NAME(minWidth).PUBLIC();
	FIELD().NAME(minHeight).PUBLIC();
	FIELD().NAME(maxSize).PUBLIC();
	FIELD().NAME(maxWidth).PUBLIC();
	FIELD().NAME(maxHeight).PUBLIC();
	FIELD().NAME(weight).PUBLIC();
	FIELD().NAME(widthWeight).PUBLIC();
	FIELD().NAME(heigthWeight).PUBLIC();
...
CLASS_FIELDS_META(o2::WidgetLayoutData)
{
	...
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(0, 0)).NAME(anchorMax).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(0, 0)).NAME(offsetMin).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(10, 10)).NAME(offsetMax).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(0, 0)).NAME(minSize).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(10000, 10000)).NAME(maxSize).PUBLIC();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(Vec2F(1, 1)).NAME(weight).PUBLIC();
	FIELD().NAME(childrenWorldRect).PUBLIC();
	FIELD().DEFAULT_VALUE(false).NAME(drivenByParent).PUBLIC();
