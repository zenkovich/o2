...
CLASS_FIELDS_META(o2::Widget)
{
	...
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::WidgetLayer).NAME(mLayers);
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().EDITOR_PROPERTY_ATTRIBUTE().INVOKE_ON_CHANGE_ATTRIBUTE(OnStatesListChanged).DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).NAME(mStates);
	FIELD().PROTECTED().DEFAULT_VALUE(nullptr).NAME(mParentWidget);
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::Widget).NAME(mChildWidgets);
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::Widget).NAME(mInternalWidgets);
	...
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).DEFAULT_VALUE(nullptr).NAME(mFocusedState);
	...
	FIELD().PROTECTED().DONT_DELETE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).DEFAULT_VALUE(nullptr).NAME(mVisibleState);
