...
namespace o2
{
    ...
    public:
        ...
        Ref<WidgetState> AddState(const String& name, const AnimationAssetRef& animation);
...
#if IS_EDITOR
    public:
        class LayersEditable : public SceneEditableObject, public ISerializable, public RefCounterable, public ICloneableRef
        {
        public:
        ...
        class InternalChildrenEditableEditable : public SceneEditableObject, public ISerializable, public RefCounterable, public ICloneableRef
        {
        public:
            WeakRef<Widget> widget;
