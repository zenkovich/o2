...
CLASS_FIELDS_META(o2::WidgetLayerLayout)
{
	...
	PRIVATE_FIELD(mWidgetLayer).DEFAULT_VALUE(nullptr);
	PRIVATE_FIELD(mAnchorMin).DEFAULT_VALUE(Vec2F(0, 0)).SERIALIZABLE_ATTRIBUTE();
	PRIVATE_FIELD(mAnchorMax).DEFAULT_VALUE(Vec2F(1, 1)).SERIALIZABLE_ATTRIBUTE();
	PRIVATE_FIELD(mOffsetMin).DEFAULT_VALUE(Vec2F(0, 0)).SERIALIZABLE_ATTRIBUTE();
	PRIVATE_FIELD(mOffsetMax).DEFAULT_VALUE(Vec2F(0, 0)).SERIALIZABLE_ATTRIBUTE();
}
END_META;
