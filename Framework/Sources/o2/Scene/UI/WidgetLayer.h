...
CLASS_METHODS_META(o2::WidgetLayer)
{
	...
	FUNCTION().PUBLIC().SCRIPTABLE_ATTRIBUTE().SIGNATURE(void, SetParent, Ref<WidgetLayer>);
	FUNCTION().PUBLIC().SCRIPTABLE_ATTRIBUTE().SIGNATURE(Ref<WidgetLayer>, GetParent);
	FUNCTION().PUBLIC().SCRIPTABLE_ATTRIBUTE().SIGNATURE(Ref<WidgetLayer>, AddChild, Ref<WidgetLayer>);
	FUNCTION().PUBLIC().SCRIPTABLE_ATTRIBUTE().SIGNATURE(void, RemoveChild, Ref<WidgetLayer>, bool);
	...
	FUNCTION().PUBLIC().SIGNATURE(Ref<WidgetLayer>, AddChildLayer, const String&, IRectDrawable*, const Layout&, float);
