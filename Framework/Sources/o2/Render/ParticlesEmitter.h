...
CLASS_FIELDS_META(o2::ParticlesEmitter)
{
	...
	PROTECTED_FIELD(mShape).DEFAULT_VALUE(nullptr).EDITOR_PROPERTY_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEffects).EDITOR_PROPERTY_ATTRIBUTE().SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mParticlesNumLimit).DEFAULT_VALUE(100).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mPlaying).DEFAULT_VALUE(true).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmittingCoefficient).DEFAULT_VALUE(1.0f).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mIsParticlesRelative).DEFAULT_VALUE(true).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mIsLooped).DEFAULT_VALUE(false).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mDuration).DEFAULT_VALUE(1).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mParticlesLifetime).DEFAULT_VALUE(0.5f).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesPerSecond).DEFAULT_VALUE(10).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesAngle).DEFAULT_VALUE(0).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesAngleRange).DEFAULT_VALUE(45.0f).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesSize).DEFAULT_VALUE(Vec2F(10, 10)).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesSizeRange).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesSpeed).DEFAULT_VALUE(10).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesSpeedRangle).DEFAULT_VALUE(5).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesMoveDirection).DEFAULT_VALUE(0).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesMoveDirectionRange).DEFAULT_VALUE(45.0f).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesAngleSpeed).DEFAULT_VALUE(0);
	PROTECTED_FIELD(mEmitParticlesAngleSpeedRange).DEFAULT_VALUE(0);
	PROTECTED_FIELD(mEmitParticlesColorA).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mEmitParticlesColorB).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mCurrentTime).DEFAULT_VALUE(0);
	PROTECTED_FIELD(mEmitTimeBuffer).DEFAULT_VALUE(0);
	PROTECTED_FIELD(mParticlesMesh).DEFAULT_VALUE(nullptr);
	PROTECTED_FIELD(mParticles);
	PROTECTED_FIELD(mDeadParticles);
	PROTECTED_FIELD(mNumAliveParticles).DEFAULT_VALUE(0);
