...
{
	PUBLIC_FIELD(enabledForcibly).EDITOR_IGNORE_ATTRIBUTE().ANIMATABLE_ATTRIBUTE();
	PUBLIC_FIELD(transparency);
	PUBLIC_FIELD(resTransparency).EDITOR_IGNORE_ATTRIBUTE().ANIMATABLE_ATTRIBUTE();
	...
	PUBLIC_FIELD(onShow);
	PUBLIC_FIELD(onHide);
	PROTECTED_FIELD(mLayers).SERIALIZABLE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::WidgetLayer).DONT_DELETE_ATTRIBUTE();
	PROTECTED_FIELD(mStates).SERIALIZABLE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).DONT_DELETE_ATTRIBUTE();
	PROTECTED_FIELD(mParentWidget);
	PROTECTED_FIELD(mChildWidgets).DEFAULT_TYPE_ATTRIBUTE(o2::Widget).DONT_DELETE_ATTRIBUTE();
	PROTECTED_FIELD(mInternalWidgets).SERIALIZABLE_ATTRIBUTE().DEFAULT_TYPE_ATTRIBUTE(o2::Widget).DONT_DELETE_ATTRIBUTE();
	...
	PROTECTED_FIELD(mFocusedState).DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).DONT_DELETE_ATTRIBUTE();
	PROTECTED_FIELD(mIsFocused);
	PROTECTED_FIELD(mIsFocusable).SERIALIZABLE_ATTRIBUTE();
	PROTECTED_FIELD(mVisibleState).DEFAULT_TYPE_ATTRIBUTE(o2::WidgetState).DONT_DELETE_ATTRIBUTE();
