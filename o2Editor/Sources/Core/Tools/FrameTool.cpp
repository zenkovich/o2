...
namespace Editor
{
	FrameTool::FrameTool()
	{
		...
		mPivotHandle.checkPositionFunc = Func(this, &FrameTool::CheckPivotSnapping);

		mLeftTopHandle.onChangedPos = Func(this, &FrameTool::OnLeftTopHandle);
		mLeftHandle.onChangedPos = Func(this, &FrameTool::OnLeftHandle);
		mLeftBottomHandle.onChangedPos = Func(this, &FrameTool::OnLeftBottomHandle);
		mTopHandle.onChangedPos = Func(this, &FrameTool::OnTopHandle);
		mBottomHandle.onChangedPos = Func(this, &FrameTool::OnBottomHandle);
		mRightTopHandle.onChangedPos = Func(this, &FrameTool::OnRightTopHandle);
		mRightHandle.onChangedPos = Func(this, &FrameTool::OnRightHandle);
		mRightBottomHandle.onChangedPos = Func(this, &FrameTool::OnRightBottomHandle);
		mPivotHandle.onChangedPos = Func(this, &FrameTool::OnPivotHandle);
		mLeftTopRotateHandle.onChangedPos = Func(this, &FrameTool::OnLeftTopRotateHandle);
		mLeftBottomRotateHandle.onChangedPos = Func(this, &FrameTool::OnLeftBottomRotateHandle);
		mRightTopRotateHandle.onChangedPos = Func(this, &FrameTool::OnRightTopRotateHandle);
		mRightBottomRotateHandle.onChangedPos = Func(this, &FrameTool::OnRightBottomRotateHandle);

		mLeftTopHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mLeftHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mLeftBottomHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mTopHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mBottomHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mRightTopHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mRightHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mRightBottomHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mPivotHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mLeftTopRotateHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mLeftBottomRotateHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mRightTopRotateHandle.onPressed = Func(this, &FrameTool::HandlePressed);
		mRightBottomRotateHandle.onPressed = Func(this, &FrameTool::HandlePressed);

		mLeftTopHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mLeftHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mLeftBottomHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mTopHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mBottomHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mRightTopHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mRightHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mRightBottomHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mPivotHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mLeftTopRotateHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mLeftBottomRotateHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mRightTopRotateHandle.onReleased = Func(this, &FrameTool::HandleReleased);
		mRightBottomRotateHandle.onReleased = Func(this, &FrameTool::HandleReleased);

		mTopHandle.checkPositionFunc = Func(this, &FrameTool::CheckTopSnapping);
		mLeftHandle.checkPositionFunc = Func(this, &FrameTool::CheckLeftSnapping);
		mBottomHandle.checkPositionFunc = Func(this, &FrameTool::CheckBottomSnapping);
		mRightHandle.checkPositionFunc = Func(this, &FrameTool::CheckRightSnapping);
		mLeftTopHandle.checkPositionFunc = Func(this, &FrameTool::CheckLeftTopSnapping);
		mLeftBottomHandle.checkPositionFunc = Func(this, &FrameTool::CheckLeftBottomSnapping);
		mRightTopHandle.checkPositionFunc = Func(this, &FrameTool::CheckRightTopSnapping);
		mRightBottomHandle.checkPositionFunc = Func(this, &FrameTool::CheckRightBottomSnapping);
