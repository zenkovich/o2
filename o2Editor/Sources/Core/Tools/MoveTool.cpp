...
namespace Editor
{
	MoveTool::MoveTool()
	{
		mHorDragHandle = SceneDragHandle(mnew Sprite("ui/UI4_right_move_arrow.png"),
										 mnew Sprite("ui/UI4_right_move_arrow_select.png"),
										 mnew Sprite("ui/UI4_right_move_arrow_pressed.png"));

		mVerDragHandle = SceneDragHandle(mnew Sprite("ui/UI4_up_move_arrow.png"),
										 mnew Sprite("ui/UI4_up_move_arrow_select.png"),
										 mnew Sprite("ui/UI4_up_move_arrow_pressed.png"));

		mBothDragHandle = SceneDragHandle(mnew Sprite("ui/UI4_move_tool_center.png"),
										  mnew Sprite("ui/UI4_move_tool_center_select.png"),
										  mnew Sprite("ui/UI4_move_tool_center_pressed.png"));
