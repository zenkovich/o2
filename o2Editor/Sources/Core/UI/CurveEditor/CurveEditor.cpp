...
namespace Editor
{
	...
	void CurveEditor::OnSelectionChanged()
	{
		mNeedRedraw = true;
	}
	...
	CurveEditor::KeyHandles::KeyHandles(const CurveHandle& mainSample, const CurveHandle& supportSample,
...
DECLARE_CLASS(Editor::CurveEditor::CurveHandle);
