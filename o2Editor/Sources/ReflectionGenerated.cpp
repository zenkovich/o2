...
void ::UIDockableWindow::InitializeType(::UIDockableWindow* sample)
{
	...
	FIELD(mDockBorder);
	FIELD(mDocked);
	FIELD(mDockingFrameSample).AddAttribute<SerializableAttribute<decltype(mDockingFrameSample)>>();
	FIELD(mDockingFrameAppearance);
	FIELD(mDockingFrameCurrent);
	FIELD(mDockingFrameTarget);
	FIELD(mNonDockSize);
	FIELD(mDragOffset);
}
...
void ::UIDockWindowPlace::InitializeType(::UIDockWindowPlace* sample)
{
	FIELD(mResizibleDir);
	FIELD(mNeighborMin);
	FIELD(mDragHandleMin);
	FIELD(mDragHandleLayoutMin);
	FIELD(mDragHandleAreaMin);
	FIELD(mNeighborMax);
	FIELD(mDragHandleMax);
	FIELD(mDragHandleLayoutMax);
	FIELD(mDragHandleAreaMax);
