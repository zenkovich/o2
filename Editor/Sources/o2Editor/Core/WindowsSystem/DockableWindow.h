...
{
	PROTECTED_FIELD(mDockSizeCoef).DEFAULT_VALUE(0.2f);
	PROTECTED_FIELD(mDockBorder).DEFAULT_VALUE(1.5f);
	PROTECTED_FIELD(mDocked).DEFAULT_VALUE(false);
	PROTECTED_FIELD(mDockingFrameSample).DEFAULT_VALUE(nullptr).SERIALIZABLE_ATTRIBUTE();
	...
	PROTECTED_FIELD(mTabState).DEFAULT_VALUE(false);
	PROTECTED_FIELD(mTabPosition).DEFAULT_VALUE(0);
	PROTECTED_FIELD(mTabActive).DEFAULT_VALUE(false);
	PROTECTED_FIELD(mTabWidth).DEFAULT_VALUE(150.0f);
	PROTECTED_FIELD(mAutoCalculateTabWidth).DEFAULT_VALUE(true);
}
END_META;
