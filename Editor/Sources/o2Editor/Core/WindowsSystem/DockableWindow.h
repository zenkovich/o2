...
{
	FIELD().DEFAULT_VALUE(0.2f).NAME(mDockSizeCoef).PROTECTED();
	FIELD().DEFAULT_VALUE(1.5f).NAME(mDockBorder).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mDocked).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().DEFAULT_VALUE(nullptr).NAME(mDockingFrameSample).PROTECTED();
	FIELD().NAME(mDockingFrameAppearance).PROTECTED();
	FIELD().NAME(mDockingFrameCurrent).PROTECTED();
	FIELD().NAME(mDockingFrameTarget).PROTECTED();
	FIELD().NAME(mNonDockSize).PROTECTED();
	FIELD().NAME(mDragOffset).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mTabState).PROTECTED();
	FIELD().DEFAULT_VALUE(0).NAME(mTabPosition).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mTabActive).PROTECTED();
	FIELD().DEFAULT_VALUE(150.0f).NAME(mTabWidth).PROTECTED();
	FIELD().DEFAULT_VALUE(true).NAME(mAutoCalculateTabWidth).PROTECTED();
}
END_META;
