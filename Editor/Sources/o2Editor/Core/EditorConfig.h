...
namespace Editor
{
    ...
    public:
        ...
        {
        public:
            Ref<WindowsLayout> mDefaultLayout; // Default windows layout, using in resetting @SERIALIZABLE

            Map<String, Ref<WindowsLayout>> mAvailableLayouts; // Available windows layouts @SERIALIZABLE
        ...
        public:
            ...
            Ref<WindowsLayout> mLayout;           // Windows layout @SERIALIZABLE
