...
{
	FIELD().DEFAULT_VALUE(true).NAME(horGridEnabled).PUBLIC();
	FIELD().DEFAULT_VALUE(true).NAME(verGridEnabled).PUBLIC();
	FIELD().DEFAULT_VALUE(false).NAME(mReady).PROTECTED();
	...
	FIELD().SERIALIZABLE_ATTRIBUTE().NAME(mBackColor).PROTECTED();
	FIELD().SERIALIZABLE_ATTRIBUTE().NAME(mGridColor).PROTECTED();
	FIELD().NAME(mViewArea).PROTECTED();
	FIELD().NAME(mViewCamera).PROTECTED();
	FIELD().DEFAULT_VALUE(Vec2F(1, 1)).NAME(mViewCameraTargetScale).PROTECTED();
	FIELD().DEFAULT_VALUE(0.1f / 120.0f).NAME(mViewCameraScaleSence).PROTECTED();
	FIELD().DEFAULT_VALUE(30.0f).NAME(mViewCameraScaleElasticyCoef).PROTECTED();
	FIELD().NAME(mViewCameraTargetPos).PROTECTED();
	FIELD().NAME(mViewCameraVelocity).PROTECTED();
	FIELD().DEFAULT_VALUE(30.0f).NAME(mViewCameraPosElasticyCoef).PROTECTED();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mViewCameraVelocityDampingCoef).PROTECTED();
	FIELD().DEFAULT_VALUE(0.001f).NAME(mViewCameraMinScale).PROTECTED();
	FIELD().DEFAULT_VALUE(10000.0f).NAME(mViewCameraMaxScale).PROTECTED();
	FIELD().NAME(mLocalToScreenTransform).PROTECTED();
	FIELD().NAME(mScreenToLocalTransform).PROTECTED();
}
END_META;
