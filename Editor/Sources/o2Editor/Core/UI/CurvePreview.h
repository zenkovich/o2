...
{
	PROTECTED_FIELD(mCurve).DEFAULT_VALUE(nullptr);
	PROTECTED_FIELD(mNeedRedraw).DEFAULT_VALUE(false);
	PROTECTED_FIELD(mSprite).DEFAULT_VALUE(nullptr);
	PROTECTED_FIELD(mBackColor).DEFAULT_VALUE(Color4(225, 232, 232));
	PROTECTED_FIELD(mCurveColor).DEFAULT_VALUE(Color4(44, 62, 80));
}
END_META;
