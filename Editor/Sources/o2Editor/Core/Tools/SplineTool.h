...
namespace Editor
{
    ...
    public:
        ...
        // Sets editing spline
        void SetSpline(Ref<Spline> spline, const Function<Vec2F()>& getOrigin);
...
CLASS_METHODS_META(Editor::SplineTool)
{
    ...
    FUNCTION().PUBLIC().SIGNATURE(void, SetSpline, Ref<Spline>, const Function<Vec2F()>&);
