...
{
	FIELD().DEFAULT_VALUE(Color4(44, 62, 80, 255)).NAME(mFrameColor).PROTECTED();
	FIELD().DEFAULT_VALUE(Color4(44, 62, 80, 150)).NAME(mObjectColor).PROTECTED();
	FIELD().DEFAULT_VALUE(Color4(44, 62, 80, 100)).NAME(mParentColor).PROTECTED();
	FIELD().DEFAULT_VALUE(Color4(20, 100, 255, 255)).NAME(mAnchorsFrameColor).PROTECTED();
	FIELD().DEFAULT_VALUE(Color4(40, 255, 100, 255)).NAME(mSnapLinesColor).PROTECTED();
	FIELD().DEFAULT_VALUE(0.001f).NAME(mFrameMinimalSize).PROTECTED();
	FIELD().NAME(mLeftTopRotateHandle).PROTECTED();
	FIELD().NAME(mLeftBottomRotateHandle).PROTECTED();
	FIELD().NAME(mRightTopRotateHandle).PROTECTED();
	FIELD().NAME(mRightBottomRotateHandle).PROTECTED();
	FIELD().NAME(mLeftTopHandle).PROTECTED();
	FIELD().NAME(mLeftHandle).PROTECTED();
	FIELD().NAME(mLeftBottomHandle).PROTECTED();
	FIELD().NAME(mTopHandle).PROTECTED();
	FIELD().NAME(mBottomHandle).PROTECTED();
	FIELD().NAME(mRightTopHandle).PROTECTED();
	FIELD().NAME(mRightHandle).PROTECTED();
	FIELD().NAME(mRightBottomHandle).PROTECTED();
	FIELD().NAME(mPivotHandle).PROTECTED();
	FIELD().NAME(mAnchorsLeftTopHandle).PROTECTED();
	FIELD().NAME(mAnchorsLeftBottomHandle).PROTECTED();
	FIELD().NAME(mAnchorsRightTopHandle).PROTECTED();
	FIELD().NAME(mAnchorsRightBottomHandle).PROTECTED();
	FIELD().NAME(mAnchorsCenter).PROTECTED();
	FIELD().NAME(mFrame).PROTECTED();
	FIELD().NAME(mAnchorsFrame).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mAnchorsFrameEnabled).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mPivotHandleEnabled).PROTECTED();
	FIELD().NAME(mBeginDraggingFrame).PROTECTED();
	FIELD().NAME(mBeginDraggingOffset).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mIsDragging).PROTECTED();
	FIELD().DEFAULT_VALUE(false).NAME(mChangedFromThis).PROTECTED();
	FIELD().NAME(mBeforeTransforms).PROTECTED();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mTransformAction).PROTECTED();
	FIELD().NAME(mSnapLines).PROTECTED();
}
END_META;
