...
namespace Editor
{
    ...
    protected:
        RefPtr<Label> mNameText;       // Asset name text
        RefPtr<AssetInfo> mAssetInfo;  // Asset information
        RefPtr<WidgetState> mSelectedState; // Node selected state

        WeakPtr<AssetsIconsScrollArea> mOwner; // Owner assets scroll area
...
END_META;Ref<>.PROTECTED().SIGNATURE(void, OnCursorDblClicked, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorRightMouseReleased, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorEnter, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorExit, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorPressed, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorStillDown, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorReleased, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorReleasedOutside, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnCursorPressBreak, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnDragStart, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnDragged, const Input::Cursor&, DragDropArea*);
Ref<>.PROTECTED().SIGNATURE(void, OnDragEnd, const Input::Cursor&);
Ref<>.PROTECTED().SIGNATURE(void, OnSelected);
Ref<>.PROTECTED().SIGNATURE(void, OnDeselected);
Ref<>.PROTECTED().SIGNATURE(void, OnDropped, ISelectableDragableObjectsGroup*);
}
END_META;
// --- END META ---