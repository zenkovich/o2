...
{
	FIELD().NAME(onViewChanged).PUBLIC();
	FIELD().DEFAULT_VALUE(12.0f).NAME(mTextOffset).PRIVATE();
	FIELD().DEFAULT_VALUE(13.0f).NAME(mBigLineOffset).PRIVATE();
	FIELD().DEFAULT_VALUE(15.0f).NAME(mSmallLineOffset).PRIVATE();
	FIELD().DEFAULT_VALUE(100.0f).NAME(mOneSecondDefaultSize).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mPerfectScaleSegmentSize).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mScaleOffset).PRIVATE();
	FIELD().DEFAULT_VALUE(Color4(16, 20, 23, 64)).NAME(mBigLineColor).PRIVATE();
	FIELD().DEFAULT_VALUE(Color4(16, 20, 23, 38)).NAME(mSmallLineColor).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mScaleSmoothLerpCoef).PRIVATE();
	FIELD().DEFAULT_VALUE(0.1f).NAME(mMinScale).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mMaxScale).PRIVATE();
	FIELD().DEFAULT_VALUE(0.1f/120.0f).NAME(mScaleSense).PRIVATE();
	FIELD().DEFAULT_VALUE(15.0f).NAME(mScrollSmoothCoef).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mScrollSpeedDecreaseCoef).PRIVATE();
	FIELD().DEFAULT_VALUE(10.0f).NAME(mScrollBorderBounceCoef).PRIVATE();
	...
	FIELD().DEFAULT_VALUE(0).NAME(mTimeCursor).PRIVATE();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mSmoothViewScroll).PRIVATE();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mViewScroll).PRIVATE();
	FIELD().DEFAULT_VALUE(false).NAME(mDragViewScroll).PRIVATE();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mBeginDragViewScrollOffset).PRIVATE();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mViewScrollSpeed).PRIVATE();
	FIELD().DEFAULT_VALUE(1.0f).NAME(mViewZoom).PRIVATE();
	FIELD().DEFAULT_VALUE(1.0f).NAME(mSmoothViewZoom).PRIVATE();
	FIELD().DEFAULT_VALUE(false).NAME(mViewHasZoomed).PRIVATE();
	FIELD().DEFAULT_VALUE(false).NAME(mViewMoveDisabled).PRIVATE();
	FIELD().DEFAULT_VALUE(0.0f).NAME(mDuration).PRIVATE();
	FIELD().NAME(mTextFont).PRIVATE();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mText).PRIVATE();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mBeginMark).PRIVATE();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mEndMark).PRIVATE();
	FIELD().DEFAULT_VALUE(Layout(Vec2F(0, 1), Vec2F(0, 1), Vec2F(-6.0f, 3.0f), Vec2F(6.0f, -21.0f))).NAME(mBeginMarkLayout).PRIVATE();
	FIELD().DEFAULT_VALUE(Layout(Vec2F(0, 1), Vec2F(1, 1), Vec2F(-4.0f, 3.0f), Vec2F(6.0f, -21.0f))).NAME(mEndMarkLayout).PRIVATE();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mScrollBar).PRIVATE();
	FIELD().DEFAULT_VALUE(nullptr).NAME(mTimeLine).PRIVATE();
	FIELD().NAME(mTimeLineEventsArea).PRIVATE();
}
END_META;
