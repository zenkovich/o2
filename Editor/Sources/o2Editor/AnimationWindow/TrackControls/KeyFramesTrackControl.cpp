...
DECLARE_TEMPLATE_CLASS(o2::Ref<Editor::KeyFramesTrackControl<AnimationTrack<float>>>);
DECLARE_TEMPLATE_CLASS(o2::Ref<Editor::KeyFramesTrackControl<AnimationTrack<bool>>>);
DECLARE_TEMPLATE_CLASS(o2::Ref<Editor::KeyFramesTrackControl<AnimationTrack<Color4>>>);
DECLARE_TEMPLATE_CLASS(o2::Ref<Editor::KeyFramesTrackControl<AnimationTrack<Vec2F>>>);
