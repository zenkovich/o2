#include "C:\work\o2\Templates\EmptyProject\Platforms\Windows\..\..\Sources\ReflectionGenerated.h"
...
#include "C:\work\o2\Templates\EmptyProject\Platforms\Windows\..\..\Sources\MyApplication.h"
...
o2::Type MyApp::Tmp::type("MyApp::Tmp");
...
void MyApp::Tmp::InitializeType(MyApp::Tmp* sample)
{
	auto iobject = dynamic_cast<o2::IObject*>(sample);
}
...
void RegReflectionTypes()
{
	...
	o2::Reflection::InitializeType<MyApp::Tmp>();
