...
#undef RemoveDirectory
	...
	bool FileSystemStuff::FileCopy(const String& source, const String& dest) const
	{
		FileDelete(dest);
	...
	bool FileSystemStuff::FileDelete(const String& file) const
	{
		return DeleteFileA(file.Data()) == TRUE;
	}

	bool FileSystemStuff::FileMove(const String& source, const String& dest) const
	{
	...
	bool FileSystemStuff::FolderCreate(const String& path, bool recursive /*= true*/) const
	{
	...
	bool FileSystemStuff::FolderRemove(const String& path, bool recursive /*= true*/) const
	{
		if (!IsFolderExist(path))
			return false;
	...
	bool FileSystemStuff::IsFolderExist(const String& path) const
	{
